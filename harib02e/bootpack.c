...
void HariMain(void) {
  ...
  putfont8(binfo->vram, binfo->scrnx, 16, 10, COL8_FFFFFF, hankaku + 'B' * 16);
  putfont8(binfo->vram, binfo->scrnx, 24, 10, COL8_FFFFFF, hankaku + 'C' * 16);

  putfont8(binfo->vram, binfo->scrnx, 40, 10, COL8_FFFFFF, hankaku + '1' * 16);
  putfont8(binfo->vram, binfo->scrnx, 48, 10, COL8_FFFFFF, hankaku + '2' * 16);
  putfont8(binfo->vram, binfo->scrnx, 56, 10, COL8_FFFFFF, hankaku + '3' * 16);
