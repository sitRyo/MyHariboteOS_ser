...
void HariMain(void) {
  ...
  // asmhead.asmに記録した情報を入れる
  binfo_scrnx = (short *) 0x0ff4; // WORD(2Byte)
  binfo_scrny = (short *) 0x0ff6; // WORD(2Byte)
  binfo_vram = (int *) 0x0ff8; // DWORD(4byte)

  vram = (char *) *binfo_vram; // [binfo_vram]にvramのアドレスが入っている。
  xsize = *binfo_scrnx;
  ysize = *binfo_scrny;
